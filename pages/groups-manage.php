<?php
  ...
  if ($user::USER_TYPE == 1) {
    $groups = Group::group_obj(Group::get_all());
  }else {
    $groups = Group::group_obj(Group::get_all_by_teacher($user->teacher_id));
  }
...
if (count($groups) > 0):?>
    <div class="container">
      ...
      <?php foreach($groups as $i =>  $group):?>
        <?php $group->members_count = Group::get_members_count($group->id);?>
          <div class="col-md-4">
            <div class="group-container">
              ...
              <div class="card group">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">عدد الطلاب: <span><?php echo $group->members_count;?></span></li>
                </ul>
              </div>
            </div>
